...
\kable(mytable,caption="Statistics of 8-isoprostane and log(8-isoprostane)")
\newpage
**1. Data wrangling**
...
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Plot  of  8-isoprostane"}
is.plot1 <- boxplot(dat1$is.ad,colors="darkblue",ylab="8-isoprostane ng/ml")
```

```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Plot  of  log(8-isoprostane)"}
...
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Diagnostic plots of four final models"}
...
## Result 1
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Relationship between log(8-isoprostane) and 12-hour NO2 exposure"}
is.12h <- ggplot(dat1, aes(y =log(is.ad) , x =no2exp.12h)) +
  geom_point(shape=1, size = 2) +
   geom_point(shape=1, size = 2,color=gender) +
...
## Result 2
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Relationship between log(8-isoprostane) and 24-hour NO2 exposure"}
...
## Result 3
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Relationship between log(8-isoprostane) and 1-week NO2 exposure"}
...
## Result 4
```{r,warning=FALSE, message=FALSE,echo=FALSE,fig.cap="Relationship between log(8-isoprostane) and 2-week NO2 exposure"}
